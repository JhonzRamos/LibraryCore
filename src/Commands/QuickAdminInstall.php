...
class QuickAdminInstall extends Command
{
    ...
    public function copyInitial()
    {
        ...
        copy(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Migrations' . DIRECTORY_SEPARATOR . '2017_10_25_100527_create_files_table', ///////////
            database_path('migrations' . DIRECTORY_SEPARATOR . '2017_10_25_100527_create_files_table.php'));
