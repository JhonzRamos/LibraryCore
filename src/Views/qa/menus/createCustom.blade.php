    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group">
                {!! Form::text('icon', old('icon','fa-archive'), ['class'=>'form-control icp icp-auto', 'data-placement'=>'bottomRight', 'placeholder'=> trans('quickadmin::qa.menus-createCustom-icon_placeholder')]) !!}
